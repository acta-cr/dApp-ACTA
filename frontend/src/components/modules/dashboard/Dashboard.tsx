      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
        ...
        <Card className="bg-background/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-xl font-semibold">Wallet Information</CardTitle>
      ...
      <Card className="bg-background/80 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl">
        ...
        <CardContent>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            <Card className="p-4 bg-gradient-to-r from-[#1B6BFF]/10 to-[#1B6BFF]/5 backdrop-blur-sm border border-[#1B6BFF]/20">
            ...
            <Card className="p-4 bg-gradient-to-r from-green-400/10 to-green-400/5 backdrop-blur-sm border border-green-400/20">
              <CardContent className="p-0">
            ...
            <Card className="p-4 bg-gradient-to-r from-[#8F43FF]/10 to-[#8F43FF]/5 backdrop-blur-sm border border-[#8F43FF]/20">
              <CardContent className="p-0">
