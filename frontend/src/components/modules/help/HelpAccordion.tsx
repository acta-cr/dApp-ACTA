...
const faqContent = {
  ...
  "help.questions.getStarted.answer":
    "To get started with ACTA, first connect your Stellar wallet (like Freighter), then set up your profile in the profile section. Once configured, you can create credentials and search for existing credentials.",
