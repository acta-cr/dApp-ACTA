...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="mt-auto flex flex-col bg-transparent text-gray-800 dark:text-gray-300 py-12 px-8 md:px-12 lg:px-16 border-t border-[#F0E7CC]">
      <div className="container mx-auto flex flex-wrap justify-between items-start gap-8 max-w-7xl">
        ...
        <div className="flex flex-col gap-1">
          <h4 className="font-semibold text-base mb-2 text-[#F0E7CC]">
            Contact
          </h4>
        ...
        {/* Team Members */}
        <div>
          <h4 className="font-semibold text-base mb-1 text-[#F0E7CC]">
            Team Members
          </h4>
        ...
        {/* Social Networks */}
        <div>
          <h4 className="font-semibold text-base mb-1 text-center text-[#F0E7CC]">
            Social
          </h4>
      ...
      {/* Copyright */}
      <p className="mt-8 text-center pt-6 border-t text-sm text-white border-[#F0E7CC]">
