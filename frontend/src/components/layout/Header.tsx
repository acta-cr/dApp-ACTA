...
const Header = ({ className }: { className?: string }) => {
  ...
  return (
    <header
      className={cn(
        "flex h-12 sm:h-16 shrink-0 items-center gap-2 transition-all duration-300 ease-in-out group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12 mt-1 sm:mt-4 mb-1 sm:mb-4 px-3 sm:px-6 py-4 sm:py-6 md:py-4",
